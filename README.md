...
1. Clone the repository: `git clone https://github.com/TheGuyDangerous/onlylinks.git`
...
MySocials is licensed under the [GPL-3.0 license](https://github.com/TheGuyDangerous/onlylinks/#GPL-3.0-1-ov-file).
